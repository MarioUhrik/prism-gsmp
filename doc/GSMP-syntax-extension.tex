...
%
%Using the value $r\_j$ associated with each update $u_j$, the command $c$ defines, for each $s \in S_c$, a function $\mu_{c,s} \colon S \to \Rsetpo$ where for each $t \in S$:
