 ...
 */
public class FindAllEvents extends ASTTraverseModify // TODO MAJO - unfinished and potentially not needed anyway
{
	private List<String> eventIdents;
	
	public FindAllEvents(List<String> eventIdents)
	{
		this.eventIdents = eventIdents;
	}
