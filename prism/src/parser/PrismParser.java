...
typeCount++; if (typeCount == 2) typeDupe = getToken(0);
      ...
      default:
        ...
        if (jj_2_1(2)) {
          ...
          DistributionDec(mf.getDistributionList());
        } else {
          switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
          case GLOBAL:{
            // Global variable
...
prop = new Property(expr, name, getPrecedingCommentBlock(begin));
    ...
    case LBRACE:{
      ...
      eventNameExpr = IdentifierExpression();
      jj_consume_token(COMMA);
      paramIndexExpr = Expression(false, false);
      jj_consume_token(COMMA);
      lowerBoundExpr = Expression(false, false);
...
prop.setPosition(begin, getToken(0)); prop.setParamList(paramList) ; {if ("" != null) return prop;}
    throw new Error("Missing return statement in function");
  }
...
// Distribution declaration 
  static final public 
void DistributionDec(DistributionList distributionList) throws ParseException {ExpressionIdent name = null;
    jj_consume_token(CONST);
    jj_consume_token(DISTRIBUTION);
    // Name 
            name = IdentifierExpression();
    jj_consume_token(EQ);
    DistributionDef(distributionList, name);
    jj_consume_token(SEMICOLON);
  }

// Distribution definition
  static final public 
ExpressionIdent DistributionDef(DistributionList distributionList, ExpressionIdent name) throws ParseException {TypeDistribution type = TypeDistribution.getInstance();
        Expression firstParameter = null;
        Expression secondParameter = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EXPONENTIAL:{
      jj_consume_token(EXPONENTIAL);
type=TypeDistributionExponential.getInstance();
      jj_consume_token(LPARENTH);
      firstParameter = Expression(false, false);
      break;
      }
    case DIRAC:{
      jj_consume_token(DIRAC);
type=TypeDistributionDirac.getInstance();
      jj_consume_token(LPARENTH);
      firstParameter = Expression(false, false);
      break;
      }
    case WEIBULL:{
      jj_consume_token(WEIBULL);
type=TypeDistributionWeibull.getInstance();
      jj_consume_token(LPARENTH);
      firstParameter = Expression(false, false);
      jj_consume_token(COMMA);
      secondParameter = Expression(false, false);
      break;
      }
    case UNIFORM:{
      jj_consume_token(UNIFORM);
type=TypeDistributionUniform.getInstance();
      jj_consume_token(LPARENTH);
      firstParameter = Expression(false, false);
      jj_consume_token(COMMA);
      secondParameter = Expression(false, false);
    ...
    case ERLANG:{
      jj_consume_token(ERLANG);
type=TypeDistributionErlang.getInstance();
      jj_consume_token(LPARENTH);
      firstParameter = Expression(false, false);
      jj_consume_token(COMMA);
      secondParameter = Expression(false, false);
    ...
    jj_consume_token(RPARENTH);
distributionList.addDistribution(name, firstParameter, secondParameter, type); {if ("" != null) return name;}
    throw new Error("Missing return statement in function");
  }
...
// Module
  static final public 
parser.ast.Module Module(ModulesFile mf) throws ParseException {ExpressionIdent name = null;
...
module = new parser.ast.Module(name.getName());
    ...
    while (true) {
      ...
      event = EventDef(mf.getDistributionList());
...
// Event
  static final public 
Event EventDef(DistributionList dl) throws ParseException {ExpressionIdent eventNameIdent = null;
        ExpressionIdent distributionNameIdent = null;
        Event event;
    jj_consume_token(EVENT);
    eventNameIdent = IdentifierExpression();
    jj_consume_token(EQ);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case REG_IDENT:{
      distributionNameIdent = IdentifierExpression();
      break;
      }
    case DIRAC:
    case ERLANG:
    ...
    case UNIFORM:
    case WEIBULL:{
      distributionNameIdent = DistributionDef(dl,
                        new ExpressionIdent(eventNameIdent.getName() + "_distribution_" + eventNameIdent.getBeginLine()));
distributionNameIdent.setPosition(eventNameIdent);
      break;
      }
    default:
      jj_la1[28] = jj_gen;
    ...
    jj_consume_token(SEMICOLON);
event = new Event(eventNameIdent, distributionNameIdent); {if ("" != null) return event;}
    throw new Error("Missing return statement in function");
  }
...
Command Command() throws ParseException {String synch = null;
        ...
        Token begin = null;
        ExpressionIdent eventIdent = null;
...
comm.setSlave(true);
      ...
      case REG_IDENT:{
        eventIdent = IdentifierExpression();
  ...
  static private boolean jj_3R_31()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0